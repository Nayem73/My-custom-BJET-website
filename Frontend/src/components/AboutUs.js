          ...
          <ul className='aboutUsCards__items'>
            <li className='aboutUsCards__item'>
              <div className='aboutUsCards__item__link'>
                ...
                <div className='aboutUsCards__item__info'>
                  <h5 className='aboutUsCards__item__text'>About B-JET and the University's efforts to date</h5>
                  ...
                  <h5 className='aboutUsCards__item__text'>Our University's Achievements</h5>
            ...
            <li className='aboutUsCards__item'>
              <div className='aboutUsCards__item__link'>
                ...
                <div className='aboutUsCards__item__info'>
                  <h5 className='aboutUsCards__item__text'>Business Succession</h5>
