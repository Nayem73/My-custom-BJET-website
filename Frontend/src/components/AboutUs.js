          ...
          <ul className='cards__items'>
            <li className='cards__item'>
              <div className='cards__item__link'>
                <figure className='cards__item__pic-wrap' data-category='Our History'>
                  {/* Insert picture here */}
                  <img src={Image1} alt='Image Description' className='cards__item__img' />
                </figure>
                <div className='cards__item__info'>
                  <h5 className='cards__item__text'>About B-JET and the University's efforts to date</h5>
                  ...
                  <h5 className='cards__item__text'>Our University's Achievements</h5>
            ...
            <li className='cards__item'>
              <div className='cards__item__link'>
                <figure className='cards__item__pic-wrap' data-category='Project Succession'>
                  {/* Insert picture here */}
                  <img src={Image2} alt='Image Description' className='cards__item__img' />
                </figure>
                <div className='cards__item__info'>
                  <h5 className='cards__item__text'>Business Succession</h5>
